...
## المميزات 🌟
- **لوحة تحكم للمعلم**: إدارة المجموعات، الطلاب، إنشاء الاختبارات، وتتبع الحضور.
- **لوحة تحكم للطالب**: متابعة الاختبارات النشطة، النتائج، سجل الحضور.
...
### Attendance Routes
- `GET /api/attendance` - احصل على سجلات الحضور
- `POST /api/attendance` - سجّل الحضور
- `GET /api/attendance/student/:studentId` - احصل على حضور الطالب
